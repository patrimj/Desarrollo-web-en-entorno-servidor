...
const { socketController2 } = require('../controllers/websocket-controller2');
...
class MiServer {
    ...
    constructor() {
        ...
        this.serverWebSocket2 = require('http').createServer(this.app);
        this.io = require('socket.io')(this.serverWebSocket);
        this.io2 = require('socket.io')(this.serverWebSocket2);
    ...
    sockets(){
        ...
        this.io2.on('connection', socketController2);
    }
    ...
    listen() {
        ...
        this.serverWebSocket2.listen(process.env.WEBSOCKETPORT2, () => {
            console.log(`Servidor de WebSockets escuchando en: ${process.env.WEBSOCKETPORT2}`);
        });
    }
}
