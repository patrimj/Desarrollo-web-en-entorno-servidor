...
GET http://localhost:9090/api/usuario/1
PUT http://localhost:9090/api/usuario/1
{
  "nombre" : "Cambiar",
  "email" : "cambiar@gmail.com",
  "password": "admin123"
}
DELETE http://localhost:9090/api/usuario/1

*/

router.get('/usuarios', controladorPersona.getUsuarios); //Listar todos los usuarios
